  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          Semantics(
            identifier: 'search_submit_button',
            child: IconButton(
      ...
      body: _isSearching
          ...
          : _results.isEmpty
              ? Center(
                  child: Semantics(
                    identifier: 'search_empty_state',
                    child: const Text('No results found.', style: TextStyle(color: Colors.white70)),
                  ),
                )
              : ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return Semantics(
                      identifier: 'search_result_item_$index',
                      child: Card(
